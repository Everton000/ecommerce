                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-price">
                                            <span class="amount">R$<?php echo Utils::formatPrice($value1["vlprice"]); ?></span>
                                        </td>
                                        ...
                                        <td class="product-subtotal">
                                            <span class="amount">R$<?php echo Utils::formatPrice($value1["vltotal"]); ?></span>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount"> <?php if( $cart["vlsubtotal"] != '' ){ ?> R$<?php echo Utils::formatPrice($cart["vlsubtotal"]); ?> <?php } ?> </span></td>
                                            </tr>

                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td><?php if( $cart["vlfreight"] != '' ){ ?> R$<?php echo Utils::formatPrice($cart["vlfreight"]); ?> <?php } ?>   <?php if( $cart["nrdays"] > 0 ){ ?> <small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small></td><?php } ?>

                                            </tr>

                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong><span class="amount"> <?php if( $cart["vltotal"] != '' ){ ?> R$<?php echo Utils::formatPrice($cart["vltotal"]); ?> <?php } ?></span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
