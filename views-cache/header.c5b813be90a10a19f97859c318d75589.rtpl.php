            ...
            <div class="col-md-8">
                <div class="user-menu">
                    <ul>
                        ...
                        <?php if( Utils::checkLogin(false) ){ ?>
                        <li><a href="/profile"><i class="fa fa-user"></i> <?php echo Utils::getUserName(); ?></a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="shopping-item">
                    <a href="/cart">Carrinho - <span class="cart-amunt">R$<?php echo Utils::getCartVlSubTotal(); ?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo Utils::getCartNrQtd(); ?></span></a>
                </div>
            </div>
        </div>
    </div>
