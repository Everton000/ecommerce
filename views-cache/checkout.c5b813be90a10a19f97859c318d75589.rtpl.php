											...
											<table class="shop_table">
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$<?php echo Utils::formatPrice($cart["vlsubtotal"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
														<td>
															R$<?php echo Utils::formatPrice($cart["vlfreight"]); ?>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$<?php echo Utils::formatPrice($cart["vltotal"]); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
