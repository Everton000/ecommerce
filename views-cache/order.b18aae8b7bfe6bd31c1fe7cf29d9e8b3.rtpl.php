...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <br>
            <b>Emitido em: </b> <?php echo Utils::formatDate($order["dtregister"]); ?><br>
            <b>Pago em: </b> <?php echo Utils::formatDate($order["dtregister"]); ?>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$<?php echo Utils::formatPrice($order["vltotal"]); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo Utils::formatPrice($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>R$<?php echo Utils::formatPrice($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo Utils::formatPrice($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
