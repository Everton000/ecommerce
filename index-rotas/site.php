...
$app->post("/profile", function ()
{
    ...
    if($_POST['desemail'] !== $user->getdesemail())
    {
        ...
        {
            User::setMsgError("Esse e-mail já está sendo utilizado.");
            header("Location: /profile");
            exit;
        }
    }
...
$app->get("/boleto/:idorder", function ($idorder)
{
    ...
    $valor_cobrado = Utils::formatPrice($order->getvltotal()); // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$app->post("/profile/change-password", function ()
{
   ...
   {
       User::setMsgError("A nova senha sua confirmação são diferentes.");
       header("Location: /profile/change-password");
       exit;
   }
   ...
   {
       User::setMsgError("A sua Senha está inválida");
       header("Location: /profile/change-password");
       exit;
   }
